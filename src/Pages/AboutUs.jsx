...
const AboutUs = () => {
  return (
    <div>
      <section>
        <div
          className="pt-[970px] bg-[#f7f7f7] bg-no-repeat relative bg-center bg-cover "
          ...
          <Container className="absolute top-1/2 -translate-y-1/2  left-1/2 -translate-x-1/2">
            <div className="relative">
              <h1 className="text-5xl text-center font-bold leading-loose uppercase relative inline-block z-10">
                ...
                <span className="font-dragon text-[300px] z-[-1]  !text-primary normal-case font-thin absolute top-0 -translate-y-[37%] -right-[16%]">
                  Gelli
                </span>
              </h1>
              <div className=" translate-x-28 w-[650px] ">
                <p className="mt-16 text-start  text-base text-gray-700   font-semibold">
